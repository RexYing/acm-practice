...
public class ComplexNumber extends Number {
    ...
    */
    public ComplexNumber times(ComplexNumber w) {
        return new ComplexNumber(x*w.getReal()-y*w.getImaginary(),x*w.getImaginary()+y*w.getReal());
    }
    ...
    */
    public ComplexNumber div(ComplexNumber w) {
        ...
        return new ComplexNumber((x*w.getReal()+y*w.getImaginary())/den,(y*w.getReal()-x*w.getImaginary())/den);
    }
    
    public ComplexNumber div(double divisor) {
    	return new ComplexNumber(x / divisor, y / divisor);
    }
